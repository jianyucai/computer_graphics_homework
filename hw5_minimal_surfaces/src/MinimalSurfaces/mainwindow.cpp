...
//	connect(action_saveas_, SIGNAL(triggered()), imagewidget_, SLOT(SaveAs()));
    ...
    action_global = new QAction(tr("GlobalMethod"), this);
    action_local = new QAction(tr("LocalMethod"), this);
    ...
    connect(action_global, SIGNAL(triggered()), renderingwidget_, SLOT(Global()));
    connect(action_local, SIGNAL(triggered()), renderingwidget_, SLOT(Local()));
}
...
void MainWindow::CreateToolBars()
{
    ...
    toolbar_basic_->addAction(action_global);
    toolbar_basic_->addAction(action_local);
